...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `stok`, `satuan_id`, `jenis_id`, `harga`) VALUES
	...
	('B000001', 'Botol 1000ml', 10, 5, 9, 2500),
	('B000002', 'Tupperware', 20, 3, 9, 50000),
	('B000003', 'Face Wash', 75, 2, 8, 6800),
	('B000004', 'Jam Tangan', 48, 5, 8, 500000),
	('B000005', 'kutilang', 0, 6, 10, 100000),
	('B000006', 'razor', 8, 6, 10, 90000);
...
-- Dumping data for table ci_barang.barang_masuk: ~4 rows (approximately)
/*!40000 ALTER TABLE `barang_masuk` DISABLE KEYS */;
INSERT INTO `barang_masuk` (`id_barang_masuk`, `supplier_id`, `user_id`, `barang_id`, `jumlah_masuk`, `harga_beli`, `ttl_hrg_msk`, `tanggal_masuk`) VALUES
	('T-BM-23062700001', 4, 14, 'B000000', 21, 25000, 525000, '2023-06-27'),
	('T-BM-23062700002', 4, 14, 'B000002', 10, 100000, 1000000, '2023-06-27'),
	('T-BM-23070200001', 4, 1, 'B000001', 10, 100000, 1000000, '2023-07-02'),
	('T-BM-23070300001', 5, 14, 'B000006', 10, 50000, 500000, '2023-07-03');
...
-- Dumping data for table ci_barang.barang_penjualan: ~4 rows (approximately)
/*!40000 ALTER TABLE `barang_penjualan` DISABLE KEYS */;
INSERT INTO `barang_penjualan` (`id_barang_penjualan`, `user_id`, `pelanggan_id`, `tanggal_keluar`, `diskon`, `total_nominal`, `u_pelanggan`, `kembalian`, `grand_total`) VALUES
	('T-BK-23062700001', 1, 5, '2023-06-27', 500, 1000, 0, 0, 500),
	('T-BK-23062700002', 1, 1, '2023-06-27', 50000, 1250000, 0, 0, 1200000),
	('T-BK-23070300001', 1, 5, '2023-07-03', 10000, 150000, 0, 0, 140000),
	('T-BK-23070300002', 14, 6, '2023-07-03', 5000, 180000, 0, 0, 175000),
	('T-BK-23070500001', 1, 34, '2023-07-05', 25000, 1100000, 1100000, 25000, 1075000);
...
-- Dumping data for table ci_barang.barang_penjualan_dtl: ~4 rows (approximately)
...
INSERT INTO `barang_penjualan_dtl` (`id_detail`, `id_barang_penjualan`, `barang_id`, `harga`, `jumlah_keluar`, `total_nominal_dtl`) VALUES
	...
	(19, 'T-BK-23070300001', 'B000002', 50000, 3, 150000),
	(20, 'T-BK-23070300002', 'B000006', 90000, 2, 180000),
	(22, 'T-BK-23070500001', 'B000002', 50000, 2, 100000),
	(23, 'T-BK-23070500001', 'B000004', 500000, 2, 1000000);
...
-- Dumping data for table ci_barang.jenis: ~2 rows (approximately)
...
-- Dumping data for table ci_barang.pelanggan: ~4 rows (approximately)
...
-- Dumping data for table ci_barang.pengaturan: ~0 rows (approximately)
...
-- Dumping data for table ci_barang.satuan: ~3 rows (approximately)
...
-- Dumping data for table ci_barang.supplier: ~1 rows (approximately)
/*!40000 ALTER TABLE `supplier` DISABLE KEYS */;
INSERT INTO `supplier` (`id_supplier`, `nama_supplier`, `no_telp`, `alamat`) VALUES
	(4, 'Dimas Botol', '0891234567', 'Kabupaten Garut'),
	(5, 'joko', '0908879879', 'bandulan'),
	(708, 'prazzza', '092135123412', 'MJKT');
