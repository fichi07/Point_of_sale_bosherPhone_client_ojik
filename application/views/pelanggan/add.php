        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_pelanggan">ID Pelanggan</label>
                    <div class="col-md-9">
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-fw fa-user"></i></span>
                            </div>
                            <input value="<?= set_value('id_pelanggan'); ?>" name="id_pelanggan" id="id_pelanggan" type="text" class="form-control" placeholder="ID Pelanggan">
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input value="<?= set_value('nama_pelanggan'); ?>" name="nama_pelanggan" id="nama_pelanggan" type="text" class="form-control" placeholder="Nama Pelanggan...">
                        </div>
