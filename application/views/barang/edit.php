        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                   ...
                   <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="stok">Stok Barang</label>
                    <div class="col-md-9">
                        <div class="input-group">
                      
                        <input value="<?= set_value('stok', $barang['stok']); ?>" name="stok" id="stok" type="text" class="form-control" placeholder="Stok Barang..." readonly>
